...
export class ZardDarkMode {
  ...
  private initializeTheme(): void {
    // LogiFlow is light-only; Zard charts/cards must not follow OS or stored dark theme.
    this.themeSignal.set(EDarkModes.LIGHT);
    this.handleSystemChanges(false);
    this.initialized.set(true);
    this.updateThemeMode(false, EDarkModes.LIGHT);
  }
