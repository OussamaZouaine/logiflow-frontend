...
export class ZardSelectComponent implements ControlValueAccessor, OnDestroy {
  ...
  private unregisterScrollReposition?: () => void;
  ...
  ngOnDestroy() {
    ...
    this.unregisterScrollRepositionListener();
    this.destroyOverlay();
  }
  ...
  private open() {
    ...
    this.registerScrollRepositionListener();
  }
  ...
  private registerScrollRepositionListener(): void {
    ...
    this.unregisterScrollRepositionListener();
    const handler = () => this.overlayRef?.updatePosition();
    const scrollables: HTMLElement[] = [];
    let parent: HTMLElement | null = this.getPositionOrigin().parentElement;
  ...
  private unregisterScrollRepositionListener(): void {
    this.unregisterScrollReposition?.();
